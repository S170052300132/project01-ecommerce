...
   </c:if>
 
   <c:if test="${not empty cartForm}"></c:if>
<c:if test="${not empty cartForm.cartLines}">
...
           <a class="navi-item" href="${pageContext.request.contextPath}/shoppingCartCustomer">Enter
               Customer Info</a>
           <a class="navi-item" href="${pageContext.request.contextPath}/productList">Continue
               Buy</a>
       </form:form>
 
 
